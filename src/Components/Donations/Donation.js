        ...
        <div className='bg-white py-14 min-h-[50vh]'  id='donate'>
            <div className="donationWrapper px-10 max-w-[960px] mx-auto ">
                <div className="content grid laptop:grid-cols-1 desktop:grid-cols-1 mobile:grid-cols-1 mobile:overflow-hidden" >
                    ...
                    <div className="right flex flex-col justify-center items-left text-white" data-aos="fade-up">
                        <div className="grid grid-rows-1">
                            <p className='text-Dark text-4xl font-extrabold py-5 '>Get involved</p>
                        </div>
                        <div className="contentText flex flex-col justify-center items-left text-white">
                            ...
                            <label for="my-modal-3" class="btn modal-button mx-auto w-70 rounded-lg focus:outline-none text-lg font-bold px-5 py-2.5 border-2 border-Dark text-center mr-2 mb-2 transition-all ease-in-out duration-300 hover:bg-white hover:border-Dark hover:text-Dark">Donate Eth</label>
            ...
            <div class="modal">
                <div class="modal-box relative bg-deepDarkBg text-white">
                    ...
                    <form onSubmit={(e) => handleDonation(e)}>
                        ...
                        <button type="submit" className=" w-full rounded-lg bg-primaryBg focus:outline-none text-lg font-bold px-5 py-2.5 border-2 border-primaryBg text-center mr-2 mb-2 transition-all ease-in-out duration-300 hover:bg-transparent">Donate</button>
                    </form>
                </div>
            </div>
