...
const Steps = () => {
    ...
    return (
        <>
            <div className=" howSteps mx-auto max-w-[1000px] flex laptop:flex-row desktop:flex-row mobile:flex-col justify-evenly items-center" >
            ...
            <div className="button flex justify-center items-center w-full pb-16">
                <a rel='noreferrer' target={"_blank"} href="https://www.researchgate.net/publication/360062594_VQGAN-CLIP_Open_Domain_Image_Generation_and_Editing_with_Natural_Language_Guidance">
                    <button type="button" className="w-70 text-Dark rounded-lg focus:outline-none text-lg font-bold px-5 py-2.5 border-2 border-Dark text-center mr-2 mb-2 transition-all ease-in-out duration-300 hover:bg-Dark hover:border-white hover:text-white" data-aos="fade-up">Learn More </button>
                </a>
